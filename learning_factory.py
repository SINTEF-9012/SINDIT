...
class DtLearningFactory(dtFactory):

    def __init__(self, graph=nx.DiGraph(), file_path="", env=simpy.Environment()):

        super().__init__(graph=graph, file_path=file_path, env=env)
        ...
        self.name = 'fischertechnik learning factory'
    ...
    def create_factory_graph(self):
        ...
        S1_1 = dtSensor.dtSensor('MQTT i/bme680:t', 'temperature')
