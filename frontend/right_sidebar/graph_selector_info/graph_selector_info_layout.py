    ...
    return html.Div(
        children=[
            ...
            html.Pre(
                ...
                children=[get_info_content(None)],
            ),
        ]
    )
...
def get_info_content(selected_el_json):
        ...
        info_rows.append(
            html.Tr(
                children=[
                    ...
                    html.Td("NODE" if selected_el.is_node else "EDGE"),
                ],
                className="custom-table-row",
            )
        )
    ...
    return dbc.Table(
        children=[html.Tbody(children=[header_row] + info_rows)], bordered=False
    )
