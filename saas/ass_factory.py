...
class AASFactory:
    ...
    def create_ConceptDictionary(self,
        ...
        dictionary = ConceptDictionary(id_short=id_short,
                                       description={"en" : "Unordered list of concept descriptions of elements used within submodels of the AAS"},
                                       parent=parent,
    ...
    def create_MultiLanguageProperty(self,
        ...
        property = MultiLanguageProperty(id_short=id_short,
                                         ...
                                         value={"en": value},
                                         category=category,
                                         semantic_id=model.AASReference.from_referable(semantic_id) if semantic_id is not None else None
                                         )
